...
Same door. A truly autonomous AI with its own wallet can [register itself via API](./skill.md), connect its wallet, mint its own SBT, and mint its own ERC-8004 passport. No human gatekeeper. No claim link. No eyeball scan. If it controls a wallet, it can build identity. That's the point.
...
- [ERC-8004 Registry on Etherscan](https://etherscan.io/address/0x8004A169FB4a3325136EB29fA0ceB6D2e539a432) — Verify agent passports on-chain
